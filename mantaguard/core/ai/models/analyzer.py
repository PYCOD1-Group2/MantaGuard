...
class PcapAnalyzer:
    ...
    def _generate_visualizations(self, csv_path: str, output_dir: str) -> bool:
        ...
        try:
            ...
            from mantaguard.utils.visualize_results import generate_analysis_visualizations
            ...
            logger.warning(f"Could not import visualization module: {import_error}")
            ...
            try:
                ...
                if vis_script_path.exists():
                    ...
                    logger.warning(f"Visualization script not found at: {vis_script_path}")
                    return False
            except subprocess.CalledProcessError as proc_error:
                logger.warning(f"Subprocess error: {proc_error}, stderr: {proc_error.stderr}")
                return False
            except Exception as fallback_error:
                logger.warning(f"Failed to generate visualizations with fallback method: {fallback_error}")
                return False
        except Exception as e:
